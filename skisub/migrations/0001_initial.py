    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('billclass', models.CharField(blank=True, choices=[('recharge_card', 'recharge_card'), ('data', 'data'), ('sme_data', 'sme_data'), ('flight_booking', 'flight_booking'), ('car_rentage', 'car_rentage'), ('electricity', 'electricity'), ('cabletv', 'cabletv')], default='sme_data', max_length=250, null=True)),
                ...
                ('departdate', models.DateField(blank=True, null=True)),
                ('flightclass', models.CharField(blank=True, choices=[('economy', 'economy'), ('firstclass', 'firstclass'), ('nostop', 'nostop'), ('others', 'others')], default='economy', max_length=100, null=True)),
